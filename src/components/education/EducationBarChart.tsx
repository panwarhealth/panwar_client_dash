 ...
 * bubbles precisely to the top of a specific bar. Identical component to the
 * employee editor (which additionally wires onBarClick for annotating).
 */
...
export function EducationBarChart({
  ...
  // Scale the axis to the displayed window only - points outside it may
  // exist when the window is narrower than the data.
        ...
        return (
          <div
            ...
            className={
              ...
              (onAnnotationClick ? 'cursor-pointer hover:border-client-primary' : '')
            }
